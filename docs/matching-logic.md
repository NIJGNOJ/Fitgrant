...
| 업종 | `industries` 제한 사업인데 업종 불일치 (업태를 밝힌 경우만) | 현재 5건 태깅(제조·디자인서비스 한정 사업: 소공인 스마트제조·디자인전문기업육성·디자인주도 제조혁신·섬유패션 친환경인증·디자인 시장개척단). 미입력이면 미적용 |
| 고용규모 | `small_biz_only` 사업인데 상시근로자 기준 초과 (근로자 수를 밝힌 경우만) | 소상공인 전용 6건. 제조 10인·그 외 5인 미만(업종 미입력이면 관대한 10인 기준). 미입력이면 미적용 |
...
| confirmed 신뢰도 | +7 |
| 지원규모 1억↑ / 1천만↑ | +6 / +3 |
| 소규모 기업(연매출 10억↓) ↔ 소상공인·창업·자금 사업 | +3 |
