...
신뢰도: `confirmed` 29 / `needs_review` 35 — 후자는 [검토 체크리스트](docs/needs-review-checklist.md)로 2026 공고 재확인 (패션특화 A 12건·대표 B 3건 검증 완료, 범용 C 24건 진행 예정).
...
- [x] `needs_review` 2026 원문 보강 — A 패션특화 12건 · B 대표 3건
- [ ] **마감 알림 (PWA 푸시/이메일) ← 다음**
- [ ] `needs_review` 범용 C 24건 보강
