...
신뢰도: `confirmed` 44 / `needs_review` 20 — needs_review 39건 전체를 [검토 체크리스트](docs/needs-review-checklist.md) 기준 **2026 공고로 검증 완료**(A 패션특화 12·B 대표 3·C 범용 24). 확인 못 한 항목만 needs_review로 정직하게 남김.
...
- [x] `needs_review` 39건 2026 공고 검증 완료 (A 12·B 3·C 24 → confirmed 44/64)
- [ ] **마감 알림 (PWA 푸시/이메일) ← 다음**
